...
def main():
	base_path = "./"
	pdf_file = os.path.join(base_path + "/" + "1611.00111.pdf")
	txt_file = os.path.join(base_path + "/" + "pdf_text.txt")
	...
	with open(txt_file, "w") as my_txt:
		my_txt.write(extracted_text.encode("utf-8"))
