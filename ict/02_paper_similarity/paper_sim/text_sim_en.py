...
def text_process(file_1, file_2, stopwords_name, symbols_name):
	...
	texts_filtered_stopwords = [[word for word in document if not word in en_stopwords] for document in texts_lower]
...
if __name__ == '__main__':
	paper_1, paper_2 = 'a.txt', 'b.txt'
	stopwords_name = 'stopwords_en.txt'
